                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                年龄
                                                <input type="text" id="ageStartSearch" style="width: 100px;" onchange="ageChickValue(this)"   class="form-control " placeholder="开始" aria-controls="tableId">
                                            </label>
                                                -
                                            <label>
                                                <input type="text" id="ageEndSearch" style="width: 100px;" onchange="ageChickValue(this)"     class="form-control" placeholder="结束" aria-controls="tableId">
                                            </label>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //重置密码
        var editBtn = document.createElement('button');
        var editAttr = 'resetPassword(' + item.id + ')';
        editBtn.setAttribute("type", "button");
        editBtn.setAttribute("class", "btn btn-warning btn-sm 修改");
        editBtn.setAttribute("onclick", editAttr);
        editBtn.innerHTML = "重置密码";
        btnGroup.appendChild(editBtn);
        //删除按钮
    ...
    function resetPassword(id) {
        //填充下拉框选项
        http("yonghu/resetPassword?yonghuId="+id, "GET", {}, (res) => {
            if(res.code == 0){
                alert("重置密码成功");
            }else{
                alert("重置密码失败");
