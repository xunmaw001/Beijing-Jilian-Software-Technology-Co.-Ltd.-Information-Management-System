                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>项目进度</label>
                                    <input id="xiangmujinduValue" name="xiangmujinduValue" class="form-control"
                                           v-model="ruleForm.xiangmujinduValue" readonly>
                                </div>
...
<script>
    ...
    function setDownloadBtn() {
        var xiangmuFileUrl = "download('" + ruleForm.xiangmuFile + "')";
        $("#xiangmuFile").attr("onclick", xiangmuFileUrl);
